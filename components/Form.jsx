  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form action="" onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
        ...
        <label htmlFor="">
          <span className='font-satoshi font-semibold text-base text-gray-700'>Tag </span> <span>(#programming, #web)</span>
          <input
            value={post.tag}
        ...
        <div className="mx-3 mb-5 flex-end gap-4">
          ...
          <button
            type='submit'
            disabled={submitting}
            className='px-5 py-1.5 text-sm bg-primary-orange rounded-full text-white mx-2'
